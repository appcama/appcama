...
const sectionLabels: Record<keyof VisibleSections, string> = {
  filtros: "Filtros",
  resumoCadastro: "Resumo de Cadastro",
...
function DashboardContent() {
  ...
  return (
    <div ref={dashboardRef} className={cn(
      "p-4 sm:p-6 space-y-6 bg-background",
      ...
      {/* KPIs - Collapsible */}
      {visibleSections.resumoCadastro && (
      ...
      {visibleSections.graficos && data?.residuosPorTipo && (
